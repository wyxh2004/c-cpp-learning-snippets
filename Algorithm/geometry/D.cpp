...
int main()
{
    ...
    {
        return length(a[p[i] - 1] - a[p[j] - 1]);
    };

    do
    {
        if ((dist(1, 2) == dist(2, 3)) and
            (dist(2, 3) == dist(3, 4)) and
            (dist(3, 4) == dist(4, 1)) and
            (dist(1, 3) == dist(2, 4)) and
            (dist(5, 6) == dist(7, 8)) and
            (dist(6, 7) == dist(5, 8)) and
            (dist(5, 7) == dist(6, 8)))
        {
            printf("YES\n%d %d %d %d\n%d %d %d %d", p[1], p[2], p[3], p[4], p[5], p[6], p[7], p[8]);
            return 0;
        }
